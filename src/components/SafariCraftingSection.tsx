...
export default function SafariCraftingSection() {
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden" ref={ref}>
      {/* Decorative */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#B78A42]/30 to-transparent" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#333333] mb-6 leading-tight">
              ...
              <span className="text-[#B78A42]">Ngorongoro Crater</span>
            </h2>
            ...
            <p className="text-lg text-[#333333]/60 leading-relaxed mb-6">
            ...
            <p className="text-base text-[#333333]/50 leading-relaxed mb-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-[#333333] hover:bg-[#2A2A2A] text-white font-bold text-sm tracking-wider px-8 py-6 rounded-full transition-all duration-300 group">
                VIEW ITINERARIES
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="outline" className="border-[#B78A42] text-[#B78A42] hover:bg-[#B78A42]/10 font-semibold text-sm tracking-wider px-8 py-6 rounded-full">
                CUSTOM TRIP
              </Button>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="text-center">
                <div className="text-2xl font-bold text-[#333333]">...with</div>
                <div className="text-lg font-bold text-[#B78A42]">Experience</div>
              </div>
            </motion.div>

            {/* Floating accent */}
            <div className="absolute -bottom-4 -left-4 w-32 h-32 border-2 border-[#B78A42]/20 rounded-2xl -z-0" />
          </motion.div>
        </div>
      </div>
    </section>
