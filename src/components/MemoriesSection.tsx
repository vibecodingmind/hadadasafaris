...
export default function MemoriesSection() {
  ...
  return (
    <section id="about" className="py-24 bg-[#1B4332] relative overflow-hidden" ref={ref}>
      {/* Decorative elements */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-[#C8A45C]/20 flex items-center justify-center">
                  <Star className="w-5 h-5 text-[#C8A45C]" />
                </div>
                <div>
                  <div className="text-sm font-bold text-[#1B4332]">4.9/5 Rating</div>
                  <div className="text-xs text-[#588157]">500+ Reviews</div>
                </div>
              </div>
              <div className="flex gap-0.5">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star key={star} className="w-4 h-4 fill-[#C8A45C] text-[#C8A45C]" />
                ))}
              </div>
            </motion.div>

            {/* Floating accent */}
            <div className="absolute -top-4 -left-4 w-24 h-24 border-2 border-[#C8A45C]/30 rounded-2xl" />
          </motion.div>
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-[#C8A45C]">Forever?</span>
            </h2>
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                <div key={item.title} className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-[#C8A45C]/20 flex items-center justify-center">
