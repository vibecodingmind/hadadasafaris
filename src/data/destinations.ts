...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    image: '/images/balloon-safari-hero.png',
    heroImage: '/images/balloon-safari-hero.png',
    ...
    longDescription: 'Few experiences capture the magic of the African wilderness quite like a hot air balloon safari over the Serengeti. As dawn breaks across the vast golden plains, you\'ll ascend silently into the sky, leaving the earth behind as the sun paints the horizon in shades of amber and rose. Below you, the Serengeti awakens — herds of wildebeest stretch to the horizon, elephants lumber through acacia groves, and predators return from their nightly hunts. From your vantage point hundreds of feet above, the sheer scale and beauty of the Serengeti unfolds in a way impossible to comprehend from the ground. Your experienced pilot navigates the balloon to follow the morning\'s wildlife spectacles, sometimes descending low for intimate views and other times rising to reveal the breathtaking panorama of the endless plains. The flight lasts approximately one hour, but the memories last a lifetime. Upon landing, celebrate with a traditional champagne toast before being escorted to a lavish bush breakfast set beneath a spreading acacia tree — complete with crystal, linen, and a full English breakfast cooked before you on the plains. This is not merely an activity; it is the crown jewel of any Tanzanian safari — a once-in-a-lifetime experience that defines luxury in the wild.',
    ...
    accordion: [
      { question: 'What time does the balloon safari depart?', answer: 'Balloon safaris depart at dawn, typically around 6:00 AM depending on the season. You will be collected from your lodge approximately one hour before sunrise to ensure you are at the launch site in time to watch the balloon being inflated — itself a magical experience.' },
      { question: 'How long is the balloon flight?', answer: 'The flight lasts approximately one hour, though the entire experience including pre-flight preparation, the flight itself, champagne toast, and bush breakfast takes roughly 4 to 5 hours from pick-up to return to your lodge.' },
      { question: 'Is the balloon safari safe?', answer: 'Absolutely. Balloon safaris are operated by highly experienced, internationally licensed pilots with impeccable safety records. The balloons are maintained to the highest international standards and flights only proceed when weather conditions are ideal.' },
      { question: 'What should I wear and bring?', answer: 'Wear layered clothing as early mornings on the Serengeti can be cool before warming up quickly after sunrise. Comfortable closed shoes, a hat, sunglasses, and a camera are essential. A small bag for personal items is recommended — space in the basket is shared.' },
      { question: 'Can children participate?', answer: 'Children aged 7 and above are welcome on balloon safaris. The experience is magical for families, though parents should consider whether young children will be comfortable standing for the duration of the flight in the basket.' },
      { question: 'What happens after landing?', answer: 'After a safe landing, you will enjoy a traditional champagne toast to celebrate your flight. This is followed by a sumptuous bush breakfast served on the plains — a truly unforgettable dining experience complete with eggs cooked to order, fresh pastries, tropical fruits, and spectacular views.' },
    ],
    gallery: [
      '/images/balloon-safari-hero.png',
      '/images/balloon-inflation.png',
      '/images/balloon-aerial.png',
      '/images/balloon-champagne.png',
      '/images/balloon-breakfast.png',
      '/images/balloon-safari.png',
    ],
    climateZones: [
